...
MRA uses the `path_only` hook for ADR-004 state-deletion custody. Its custom
collector/deletion-only workflow exception remains authoritative; these stages
do not configure the generic exclusions-only policy for MRA. See ADR-005.
