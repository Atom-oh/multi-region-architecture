...
executors and the required MRA guard profile, which blocks raw fallback until its
adapter arrives in PR #55 and fixes chair time/turn limits immediately. Workflow
activation follows in PR #56. The policy PR #53 rationale is preserved below.
