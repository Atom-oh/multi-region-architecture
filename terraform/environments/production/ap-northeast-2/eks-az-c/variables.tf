...
# The mgmt cluster trust inputs (mgmt_cluster_name, default_mgmt_cluster_name,
# expected_mgmt_vpc_id, expected_mgmt_tags, mgmt_cluster_security_group_id) are deliberately NOT
